...
<body background="b.jpg" style='width:100;height:100%;position:center no repeat;'>
<h1>Master Class</h1>
<div id="form">
<form method="post" name="form">
<label id="label">Session:</label>
<input type="number" id="session" placeholder="2019-2020">
<br><input type="number" id="name" placeholder="Enter Class Name" align="center">
